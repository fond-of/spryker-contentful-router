...
class BlogCategoryResourceCreatorPlugin implements ResourceCreatorPluginInterface
{
    private const RESOURCE_TYPE = 'blog';

    private const ACTION_NAME = 'category';
    ...
    /**
     * BlogCategoryResourceCreator constructor.
     *
